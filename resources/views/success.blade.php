      ...
      <div class="stepper" style="color: black;">
        <div class="jumbotron" style="background: #fff;">
          <div class="row text-center">
            <img style="margin: 0 auto;" src="{{asset("colina/assets/images/download.png")}}" alt="Payment Successful" />
            {{-- <img src="{{ $deal->hotel->picture_url}}" alt=" {{$deal->hotel->address}}" /> --}}
          </div>
          <div class="text-center">
            <p style="font-weight: bold;">Payment Successful</p>      
            <p style="font-size: 15px;">You will receive your payment as soon as your reservation(s) are sold.</p>
            <p style="font-size: 15px;">Thank you!</p>

            <p class="text-center" style="margin-top: 15px;"><a href="/" class="btn btn-main">RETURN TO HOME PAGE<span class="icon icon-chevron-right"></span></a></p>
          </div>
        </div>
      </div>
    </div>
