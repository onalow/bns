        ...
        <div class="stepper" style="color: black;">
          <div class="jumbotron" style="background: #fff;">
            ...
            <div class="text-center">
              <p style="font-weight: bold;">Payment Sent</p>      
              <p style="font-size: 15px;">Your reservation(s) has been sold and the payment sent to your wallet.</p>
              <p style="font-size: 15px;">It should arrive in your wallet as soon as possible depending on the bitcoin network traffic.</p>
