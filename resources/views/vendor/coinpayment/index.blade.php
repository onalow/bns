              ...
              <tr>
                <td class="text-center" colspan="2">
                  ...
                  <div class="text-danger">
                    <small>Do not send value to us if address status is expired!</small> <br>
                    <small>Kindly note that any payment less than @{{ payment.first.amount }} @{{ payment.last.coin }} will not be processed.</small>
                  </div>
                </td>
              </tr>
              <tr>
